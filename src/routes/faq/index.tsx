...
const About: FunctionalComponent = () => {
  return (
    <section class="container py-5">
      ...
      <p>This is most defiantly Psilly. You either know what Psilly is already or it can't be explained to you with mere words. <Link href="/shrooms/">Psilly Simon</Link> may have an answer. So else may <Link href="/psilosophy/">psilosophizing</Link>.</p>
