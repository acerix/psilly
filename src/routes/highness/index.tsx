...
const Highness: FunctionalComponent<HighnessProps> = (props: HighnessProps) => {
  ...
  return (
    <section class="container py-5">
      ...
      {highness==='too high' && <div><audio controls><source src="/help.flac" type="audio/flac"><a href="/help.flac" target="_blank">Help!</a></source></audio><p>A slow, calm chat may help you relax, try <a href="https://chat.tripsit.me/chat/?a=1#sanctuary" target="_blank" rel="noreferrer">TripSit</a>.</p></div>}
    </section>
  )
}
