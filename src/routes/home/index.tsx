  ...
  return (
    <section class="container">
        ...
        <div class="overflow-hidden" style="max-height: 30vh;">
          <div class="container px-5">
            <Link href="/art/polygons">
              <img src="/assets/art/thumbnails/polygons.png" class="img-fluid border rounded-3 shadow-lg mb-4" alt="polygons" width="700" height="500" loading="lazy" />
            </Link>
          </div>
        </div>
      </div>
      ...
      <div class="row row-cols-1 row-cols-sm-2 row-cols-md-3 row-cols-lg-4 g-4 py-5">
        ...
        <div class="col d-flex align-items-start">
          <div>
            <h4 class="fw-bold mb-0">Psychedelic Mushrooms</h4>
        ...
        <div class="col d-flex align-items-start">
          <div>
            <h4 class="fw-bold mb-0">Psychotropic Science</h4>
        ...
        <div class="col d-flex align-items-start">
          <div>
            <h4 class="fw-bold mb-0">Dimethyltryptamine, Darling</h4>
        ...
        <div class="col d-flex align-items-start">
          <div>
            <h4 class="fw-bold mb-0">Quantum Psychedelics</h4>
