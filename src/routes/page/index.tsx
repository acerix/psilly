...
const cms = {
  ...
  play: <Fragment><h1>Play</h1><p>Have phun!</p><p>When in doubt, <a href="/page/games/">play the game</a>.</p><p>Or <a href="/jam/">play music</a>.</p><p>If all else fails, get a <a href="/page/life/">life</a>.</p><p><a href="https://ludotune.com/" target="_blank" rel="noreferrer">ludotune</a>.</p></Fragment>,
