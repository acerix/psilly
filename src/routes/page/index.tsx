...
const cms = {
  ...
  shrooms: <Fragment><h1><abbr title="Psilocybe Mushrooms">Shrooms</abbr></h1><p>Make room for the mush rooms, these fun guys need space! While the fruiting bodies may be sporeatic, they are phallacies; my Celia holds the truth. Look into Psilly Psimon's cube and see.</p><p>Les psilocybes sont la crème de la merde.️ 💩 🍄 👨‍🍳️ 😝 🙃</p><h2>Chocolate Mushrooms</h2><p><em>You</em> may love the taste of dried psilocybe cubensis mushrooms, but for the rest of us with taste buds; there's chocolate. Dip 'em, dredge 'em, or blend 'em into a pudding.  Sweet or salty, it's up to you but always better than stale. Psilly chocolate-shroom bars are 100% organic, gluten-free, vegan, hand crafted by artisan in small batches using only fairtrade mushrooms and chocolate, and have been unblessed by a Satanic minister. They also don't exist. Available in chili, cinnamon and anchovy flavours, and in microdose or macrodose</p></Fragment>,
