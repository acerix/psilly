...
const cms = {
  ...
  psiblings: <Fragment><h1>Psibling Psites</h1><p>Psilly ain't the only trip psite on the block, check what the psychedelic network has to offer:</p><p><a href="http://www.shapesmania.com/">shapesmania.com</a></p></Fragment>,
  ...
  acid: <Fragment><p>Do you mean <a href="/lsd/">lysergic acid diethylamide</a>?</p></Fragment>,
  lsd: <Fragment><h1><abbr title="Lysergic Acid Diethylamide">LSD</abbr></h1><p>Acid erupts; absolute acid erupts absolutly.</p></Fragment>,
  ...
  ibogaine: <Fragment><h1>Ibogaine</h1><p>A drug so cool it doesn't need a nickname. But is it really a <em>drug</em>? That all depends what the definition of "<a href="/is/">is</a>" is.</p></Fragment>,
  ...
  dmt: <Fragment><h1><abbr title="N,N-Dimethyltryptamine">DMT</abbr></h1><p>DMT is constantly produced in your brain, and also in many other animals, and plants too. Come to think of it, DMT may be fundamental to life as we know it. Learn more at <a href="/dmt/">smoalk.dmt</a>.</p><h2>DMT Nexus</h2><p>No, <em>this</em> is not a nexus. <a href="https://www.dmt-nexus.me/">This</a> is a nexus.</p></Fragment>,
  ...
  life: <Fragment><h1>What is life?</h1><p>The life equation is the antidote to the anti-life equation.</p><p>The equation is mathematical proof that life is worth living, just as the anti-life.</p><p>The equation is mathematical proof that life is meaningless.</p><p>Theorize. Life is precious. And <a href="/time/">time</a> is on your side.</p></Fragment>,
  ...
  hear: <Fragment><h1>Hear</h1><p>Hear ye, hear ye!</p><p>What sayeth ye?</p><p>Ye sayeth as ye doeth.</p><p>Then what doeth ye?</p><p>Ye doeth as was proclaimed.</p><p>Ah, so ye hideth behind nomological determinism?</p><p><a href="/music/">Hear ye, hear ye!</a></p></Fragment>,
  ...
  psillys: <Fragment><h1>Psillys</h1><p>The plural of psilly is psillier.</p></Fragment>,
  psilliess: <Fragment><h1>Psilliess</h1><p>The plural of psilly is psillier.</p></Fragment>,
  psillier: <Fragment><h1>Psillier</h1><p>Psilly or what?</p></Fragment>,
