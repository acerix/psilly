...
const Terms: FunctionalComponent = () => {
  return (
    <section class="container py-5">
      ...
      <p>
        The Psilly website located at psilly.com is a copyrighted work belonging
        to Psilly Corporation. Certain features of the Site may be subject to
      ...
      <p>
        <strong>Cookies and Web Beacons.</strong> Like any other website, Psilly
      ...
      <p>
        ...
        Company should be sent to: 122 Barrette Street, Ottawa, ON, Canada.
      ...
      <p>
        Email: <a href="mailto:info@psilly.com">info@psilly.com</a>
      </p>
    </section>
  )
}
