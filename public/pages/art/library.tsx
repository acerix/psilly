...
const artworkLibrary: ArtworkLibrary = {
  'polygonous': {
    ...
    description:
      'Explores the Euclidean nature of linear geometry, from the point of view of a conscious observer, emphasizing the dichotomy of transversal relationism in a post-reactivate triptonia.',
  },
  'meld': {
    path: 'meld',
    type: 'Art',
  ...
  'golden-angle-donut': {
    ...
    medium: 'JavaScript on CanvasRenderingContext2D',
    description:
      'Draw a straight line, then starting from the end of that line, rotate by the golden angle and draw the same line in that direction.  Continue adding new lines until you have a tasty donut.',
  },
  'squibbo': {
    path: 'squibbo',
    type: 'Art',
    ...
    medium: 'JavaScript on CanvasRenderingContext2D',
    description:
      'A post-modern take on the classical interpretation of machine-assisted squibology.',
  },
  'atoms': {
    path: 'atoms',
    type: 'Art',
  ...
  'falls': {
    ...
    medium: 'JavaScript on WebGLRenderingContext',
    description:
      'An exploration of the gap between quantum chromaticism and classical gravity from a Newtonian frame of doge.',
  },
  'chillbert': {
    path: 'chillbert',
    type: 'Art',
  ...
  'develop': {
    ...
    medium: 'JavaScript on CanvasRenderingContext2D',
    description:
      'Some paintings are veloped to look like real world things, others develop.',
  },
  'quadingle': {
    path: 'quadingle',
    type: 'WIP',
    ...
    medium: 'JavaScript on WebGLRenderingContext',
    description:
      'A personalized data stream mapped to a four-way hilbert curve from the centre.',
  },
  'oh-bezier': {
    path: 'oh-bezier',
    type: 'WIP',
  ...
  'esch': {
    ...
    created: '2023',
    medium: 'JavaScript on WebGLRenderingContext',
    description: 'Esch not yet ye be eschesized.',
  },
  'canvas-template': {
  ...
  'loading': {
    ...
    description:
      'Loading... is a loading screen testing framework. Did I say framework? I mean artwork. Also tests patience.',
  },
  'grid-test': {
    path: 'grid-test',
    type: 'Test',
    ...
    created: '2021',
    medium:
      'JavaScript on CanvasRenderingContext2D over JavaScript on WebGLRenderingContext',
