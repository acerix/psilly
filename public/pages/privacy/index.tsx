  ...
  return (
    <section class="container py-5">
      ...
      <ul>
        ...
        <li>
          <p>
            ...
            this Agreement) refers to Psilly Corporation, Canada.
          </p>
        </li>
        <li>
          <p>
        ...
        <li>
          <p>
            <strong>Website</strong> refers to Psilly, accessible from{' '}
            <a href="https://psilly.com/">psilly.com</a>
          </p>
        </li>
        <li>
          <p>
      ...
      <ul>
        <li>
          <p>
            By email: <a href="mailto:info@psilly.com">info@psilly.com</a>
          </p>
        </li>
        <li>
          <p>
            By visiting this page on our website:{' '}
            <a href="/contact/">psilly.com/contact</a>
          </p>
        </li>
      </ul>
    </section>
